...
This project explores an audible interface designed for use primarily on the
...
In this paper, we argue that the imlpementation of 3D audio algorithms to create 
